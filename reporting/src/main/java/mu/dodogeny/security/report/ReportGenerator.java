package mu.dodogeny.security.report;
...
import mu.dodogeny.security.database.VulnerabilityDatabase;
...
public class ReportGenerator {
            ...
            try {
                ...
                if (scanResult.getProjectGroupId() != null && scanResult.getProjectArtifactId() != null) {
                    try {
                        ...
                        logger.warn("Failed to fetch trend data asynchronously: {}", e.getCause().getMessage());
                        model.put("trendData", java.util.Collections.emptyList());
                    } catch (InterruptedException e) {
                        Thread.currentThread().interrupt();
                        logger.warn("Trend data fetch was interrupted: {}", e.getMessage());
                        model.put("trendData", java.util.Collections.emptyList());
                    }
                }
            } catch (Exception e) {
    ...
    private void generateJsonReport(ScanResult scanResult, String outputPath) throws IOException {
        ...
        try {
            java.lang.reflect.Method getVulnerabilities = scanResult.getClass().getMethod("getVulnerabilities");
            @SuppressWarnings("unchecked")
            java.util.List<Object> vulnerabilities = (java.util.List<Object>) getVulnerabilities.invoke(scanResult);
            ...
            if (vulnerabilities != null) {
                ...
                for (Object vuln : vulnerabilities) {
                    ...
                    vulnMap.put("cveId", getFieldValue(vuln, "cveId", String.class, "N/A"));
                    vulnMap.put("description", getFieldValue(vuln, "description", String.class, "No description available"));
                    vulnMap.put("severity", getFieldValue(vuln, "severity", String.class, "UNKNOWN"));
                    vulnMap.put("cvssV3Score", getFieldValue(vuln, "cvssV3Score", Double.class, null));
                    vulnMap.put("affectedComponent", getFieldValue(vuln, "affectedComponent", String.class, "N/A"));
                    vulnMap.put("source", getFieldValue(vuln, "source", String.class, "Unknown"));
                    vulnMap.put("referenceUrl", getFieldValue(vuln, "referenceUrl", String.class, ""));
                    vulnMap.put("references", getFieldValue(vuln, "references", java.util.List.class, java.util.Collections.emptyList()));
                    vulnMap.put("detectionMethod", getFieldValue(vuln, "detectionMethod", String.class, "N/A"));
                    vulnDetails.add(vulnMap);
                }
                report.put("vulnerabilities", vulnDetails);
            }
        } catch (Exception e) {
            logger.warn("Could not add detailed vulnerability information to JSON report", e);
        }
    ...
    private void generateCsvReport(ScanResult scanResult, String outputPath) throws IOException {
        try (PrintWriter writer = new PrintWriter(new OutputStreamWriter(new FileOutputStream(outputPath), StandardCharsets.UTF_8))) {
            ...
            // Get vulnerabilities from scan result - check for vulnerabilities field
            try {
                java.lang.reflect.Method getVulnerabilities = scanResult.getClass().getMethod("getVulnerabilities");
                @SuppressWarnings("unchecked")
                java.util.List<Object> vulnerabilities = (java.util.List<Object>) getVulnerabilities.invoke(scanResult);
                ...
                if (vulnerabilities != null) {
                    for (Object vuln : vulnerabilities) {
                        // Use reflection to safely access vulnerability fields
                        String cveId = getFieldValue(vuln, "cveId", String.class, "N/A");
                        String severity = getFieldValue(vuln, "severity", String.class, "UNKNOWN");
                        Double cvssScore = getFieldValue(vuln, "cvssV3Score", Double.class, null);
                        String affectedComponent = getFieldValue(vuln, "affectedComponent", String.class, "N/A");
                        String description = getFieldValue(vuln, "description", String.class, "No description available");
                        String referenceUrl = getFieldValue(vuln, "referenceUrl", String.class, "");
                        @SuppressWarnings("unchecked")
                        java.util.List<String> references = getFieldValue(vuln, "references", java.util.List.class, java.util.Collections.emptyList());
                        String source = getFieldValue(vuln, "source", String.class, "Unknown");
                        String detectionMethod = getFieldValue(vuln, "detectionMethod", String.class, "N/A");
                ...
                // Fallback to dependency-based CSV if vulnerability access fails
