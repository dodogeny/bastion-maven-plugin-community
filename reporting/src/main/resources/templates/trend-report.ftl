...
<head>
    ...
    <title>SecHive Security Trend Analysis - ${scanResult.projectName!"Unknown Project"}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="report-container">
        ...
        <div class="content">
                                ...
                                <div class="chart-placeholder">
                                    <div class="placeholder-content">
                                        ...
                                        <div class="placeholder-text">
                                            ...
                                            <p>This interactive chart will show the evolution of vulnerable JARs and CVEs over time once you have completed multiple scans.</p>
            ...
            <!-- Multi-Module Analysis Section -->
            <#if multiModuleHistory?? && multiModuleHistory?size gt 0>
                <div class="section">
                    <h2><span class="icon">📦</span>Multi-Module Analysis</h2>
                    <div class="trend-analysis">
                        <h3>🏗️ Multi-Module Project Overview</h3>
                        <p>Analysis across ${multiModuleHistory?size} modules in this multi-module project:</p>
                        
                        <div class="analysis-points">
                            <#list multiModuleHistory as module>
                                <div class="analysis-point">
                                    <span class="icon">📋</span>
                                    <div>
                                        <strong>${module.projectName!'Module'}:</strong> 
                                        ${module.totalVulnerabilities!0} vulnerabilities in ${module.vulnerableDependencies!0} dependencies
                                    </div>
                                </div>
                            </#list>
                        </div>
        ...
        <!-- Footer -->
        <div class="footer">
            Generated by SecHive Maven Plugin v1.0.0 on ${.now?datetime}
            <br>
            <small>
                <#if scanResult.hasFirstTimeData()>
