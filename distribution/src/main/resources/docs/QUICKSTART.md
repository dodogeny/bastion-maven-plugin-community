...
2. Run Maven goal: `io.github.dodogeny:bastion-maven-community-plugin:1.2.7:scan -Dbastion.nvd.apiKey=YOUR_API_KEY`
...
mvn io.github.dodogeny:bastion-maven-community-plugin:1.2.7:help
