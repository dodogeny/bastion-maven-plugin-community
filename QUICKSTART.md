...
2. Run Maven goal: `io.github.dodogeny:bastion-maven-community-plugin:@project.version@:scan -Dbastion.nvd.apiKey=YOUR_API_KEY`
...
mvn io.github.dodogeny:bastion-maven-community-plugin:@project.version@:help
