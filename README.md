...
```bash
# Basic scan
mvn io.github.dodogeny:bastion-maven-community-plugin:1.2.7:scan
...
```bash
# Upgrade to v1.2.7 (or v1.1.0+) which includes automatic memory management
# Update your pom.xml to version 1.2.7
```

v1.1.0+ and v1.2.7 automatically configure memory allocation for OWASP subprocesses:
...
|-----------------|------------------|------------------------|-------------|-------------------|--------------|--------|
| 1.2.7 | Java 21+ | 12.1.3 | ✅ Automatic | ✅ Automatic | ✅ Enhanced | **Recommended** |
